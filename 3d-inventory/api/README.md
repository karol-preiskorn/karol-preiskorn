...
[![Build API](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/build-api.yml/badge.svg?branch=main)](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/build-api.yml)
[![Security](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/security.yml/badge.svg?branch=main)](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/security.yml)
[![Generate Badges](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/generate-badges.yml/badge.svg?branch=main)](https://github.com/karol-preiskorn/3d-inventory-api/actions/workflows/generate-badges.yml)

<!-- Repository Badges (auto-generated and committed to repo) -->

![Last Commit](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/last-commit.svg?token=GHSAT0AAAAAADRWHN3NR5BCZ76AXOIFQTTE2KTWCZA) ![Commits](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/commit-count.svg?token=GHSAT0AAAAAADRWHN3NAMHVWTAGYLNZQGJK2KTWEJA) ![Last Updated](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/last-updated.svg?token=GHSAT0AAAAAADRWHN3NWKBMR2532JPWJCIE2KTWDZA)

<!-- Tech Stack Badges -->

![TypeScript](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/typescript.svg?token=GHSAT0AAAAAADRWHN3M4VCR4ZQKYUAFH37I2KTWFFA) ![MongoDB](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/mongodb.svg?token=GHSAT0AAAAAADRWHN3MTUUT5BN7XUOJHBG42KTWFQQ) ![License](https://raw.githubusercontent.com/karol-preiskorn/3d-inventory-api/refs/heads/main/.github/badges/license.svg?token=GHSAT0AAAAAADRWHN3NMNFLUKWIEJBSHDJS2KTWFZA)
...
1. [3d-inventory-mongo-api](#3d-inventory-mongo-api)
   ...
   8. [License](#license)
      1. [Commercial Application - All Rights Reserved](#commercial-application---all-rights-reserved)
...
- **Spatial Inventory Management**: Track inventory items with 3D
  positioning and spatial relationships
- **RESTful API Services**: Provide robust endpoints for inventory
  operations (devices, models, connections, logs)
...
- **Activity Audit Logs**: Complete audit trail for all CRUD operations
  with user context
- **Login Event Tracking**: Detailed login audit logs including IP
  addresses, timestamps, and authentication outcomes
- **Change Tracking**: Before/after value tracking for device updates
  showing exactly what changed
- **User Activity Monitoring**: Track user actions across all system
  ddresses, timestamps, and authentication outcomes
...
- **User Context**: Tracks who made the change with
  [Swagger/OpenAPI](https://swagger.io/) specification:

- **Live Documentation**: Available at `https://your-api-url/doc` when
...
Copyright © 2025 Karol Preiskorn. Wszelkie prawa zastrzeżone
(All rights reserved).
